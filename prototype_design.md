...
| TTS | ElevenLabs / Fish Audio / Google Cloud TTS（切り替え可能） |
...
| TTS | ElevenLabs API / Fish Audio API / Google Cloud TTS API（`AppSetup.TtsEngine` で選択） |
| 通信 | UnityWebRequest |
